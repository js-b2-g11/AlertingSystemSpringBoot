...
public class PulseRateTest {
  ...
  public void pulseRateValue39_critical() {
    final boolean actual = pulseRate.isCritical(39);
    assertEquals(true, actual);
  }

  @Test
  public void pulseRateValue40_critical() {
    final boolean actual = pulseRate.isCritical(40);
    assertEquals(false, actual);
  }

  @Test
  public void pulseRateValue41_notCritical() {
    final boolean actual = pulseRate.isCritical(41);
    assertEquals(false, actual);
  }

  @Test
  public void pulseRateValue59_notCritical() {
    final boolean actual = pulseRate.isCritical(59);
    assertEquals(false, actual);
  }

  @Test
  public void pulseRateValue60_notCritical() {
    final boolean actual = pulseRate.isCritical(60);
    assertEquals(false, actual);
  }

  @Test
  public void pulseRateValue61_notCritical() {
    final boolean actual = pulseRate.isCritical(61);
    assertEquals(false, actual);
  }

  @Test
  public void pulseRateValue99_notCritical() {
    final boolean actual = pulseRate.isCritical(99);
    assertEquals(false, actual);
  }

  @Test
  public void pulseRateValue100_notCritical() {
    final boolean actual = pulseRate.isCritical(100);
    assertEquals(false, actual);
  }

  @Test
  public void pulseRateValue101_notCritical() {
    final boolean actual = pulseRate.isCritical(101);
    assertEquals(false, actual);
  }

  @Test
  public void pulseRateValue219_notCritical() {
    final boolean actual = pulseRate.isCritical(219);
    assertEquals(false, actual);
  }

  @Test
  public void pulseRateValue220_Critical() {
    final boolean actual = pulseRate.isCritical(220);
    assertEquals(true, actual);
  }

  @Test
  public void pulseRateValue221_Critical() {
    final boolean actual = pulseRate.isCritical(221);
    assertEquals(true, actual);
  }
